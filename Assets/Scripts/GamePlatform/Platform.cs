...
namespace GamePlatform {
    public class Platform {
        ...
        public void InstantiateSelf(GameObject prefab) => _platformObject = Object.Instantiate(prefab);

        public void DestroySelf() => Object.Destroy(_platformObject);
        public void Move(Vector2 newPosition) => _platformObject.transform.position = newPosition;
